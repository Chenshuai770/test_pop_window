...
public class MaterialCalendarView extends ViewGroup {
    ...
    private void setupChildren() {
        ...
        topbar.addView(buttonPast, new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 5));
        ...
        topbar.addView(buttonFuture, new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 5));

       // cancel.setGravity(Gravity.CENTER_VERTICAL);
       //cancel.setGravity(Gravity.RIGHT);
       /* topbar.addView(cancel, new LinearLayout.LayoutParams(
